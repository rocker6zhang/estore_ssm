...
<script type="text/javascript" src="http://47.104.191.132:8089/js/store/search.js"></script>
...
<!-- 标题 -->
	<div class="row">
	  <div class="col-md-12"><div id = "header"><h1>Search result<h1></div></div>
	</div>
	...
	<div  id="search_result">
	 ...
	 <!--  <div class="col-md-4">
		  ...
		  <div class="col-md-4"><br/><br/><p style="color:red" id="search_warning">没有找到你要的商品,请换个关键词试试.</p><br/><br/></div>
		</div>
